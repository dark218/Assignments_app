...
export class AddUserComponent implements OnInit {
  ...
  constructor(public authService : AuthService, public route: ActivatedRoute, private router: Router,private sankBar : MatSnackBar){}
  ...
  onSignup(){
    ...
    this.authService.createUser(this.form.value.name,
      ...
      this.authService.updateUser(this.docId,this.form.value.name,
                                          ...
                                          this.sankBar.open("User edited!! ", 'Close');
    }
    this.form.reset();
  };
