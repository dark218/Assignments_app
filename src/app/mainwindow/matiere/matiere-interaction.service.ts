...
export class MatiereInteractionService {
  ...
  getMatiere() {
    this.http.get<{message: string, matieres: any}>('http://localhost:3000/api/matiere')
  ...
  getMatieres(id: string){
    ...
    ('http://localhost:3000/api/matiere/' + id);
  }
  ...
  addMatiere( nommat: string, nomprof: string, avatar1: File) {
    ...
    this.http.post<{message: string,matiere: Matiere}>('http://localhost:3000/api/matiere',matiereData)
  ...
  updateMatiere(id: string ,  nommat: string, nomprof: string ,avatar1: File | string){
    ...
    this.http
             .put('http://localhost:3000/api/matiere/' + id , matiereData)
             .subscribe(response => {
  ...
  deleteMatiere(matiereId: string) {
    this.http.delete('http://localhost:3000/api/matiere/' + matiereId)
      .subscribe(() => {
